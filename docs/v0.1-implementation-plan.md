...
**Progress:** Phases 0 through 7 complete. The approved product baseline is the
[PANDA v0.1 Frozen Scope Contract](v0.1-scope-contract.md), and the closed-loop
verification record is the [Phase 7 Plan](plans/phase-7.md).
