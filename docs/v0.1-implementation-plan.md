...
**Progress:** Phases 0 through 10 complete. The approved product baseline is the
[PANDA v0.1 Frozen Scope Contract](v0.1-scope-contract.md), and the legacy-model
removal record is the [Phase 10 Plan](plans/phase-10.md).
