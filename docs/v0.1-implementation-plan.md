...
**Progress:** Phases 0 through 2 complete. The approved product baseline is the
[PANDA v0.1 Frozen Scope Contract](v0.1-scope-contract.md), and the execution
and trace foundation completion record is the [Phase 2 Plan](plans/phase-2.md).
