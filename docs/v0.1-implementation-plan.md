...
Post-v0.1 development continued through
[Phase 12 — Durable Local State and Safe Restart Recovery](plans/phase-12.md)
and [Phase 13 — Authenticated API Principals and Guarded Network
Exposure](plans/phase-13.md). These phases do not retroactively broaden the
frozen v0.1 release claim.
