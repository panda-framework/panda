...
**Progress:** Phases 0 through 3 complete. The approved product baseline is the
[PANDA v0.1 Frozen Scope Contract](v0.1-scope-contract.md), and the dynamic
coordinator completion record is the [Phase 3 Plan](plans/phase-3.md).
